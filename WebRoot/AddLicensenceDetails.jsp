...
<head>
	...
	<body>
		...
		<center>
		<h3>
			<span class=subHead><br /><font color='white'>Add License Details</font></span>
		</h3>
		</center>

		<form action="./addLicenseDetailAction.do" name="license" method='post'
			...
			<table border='0' align="center" width=40% >
				...
				<tr>
					...
					<td>
						<input type="text" name="liesenceno" value="" size="20" />
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</td>
					<td></td>
					<td></td>
				...
				<tr>
					...
					<td>
						<input type="text" name="issueddate" value="" size="20" />
						<a
				...
				<tr>
					...
					<td>
						<input type="text" name="validdate" value="" size="20" />
							<a
