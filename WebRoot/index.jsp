...
<head>
    ...
    <title>Hopital Device Management</title>
...
<div id="main" class="box">
    ...
    <div id="header">
        ...
        <!-- Logotyp -->
        <h1 id="logo"><a href="./" title="Hospital Device Management[Go to homepage]">Hospital Device Management<span></span></a></h1>
        <hr class="noscreen" />          
               ...
               <!-- Active -->
                ...
                <li><a href="#">Photos<span class="tab-l"></span><span class="tab-r"></span></a></li>
                 <li><a href="#">Contact<span class="tab-l"></span><span class="tab-r"></span></a></li>
                           ...
                           <li><a href="LoginForm.jsp">login<span class="tab-l"></span><span class="tab-r"></span></a></li>
            </ul>
